const members = {
    ...
    "01814843266":{
        ...
        pre_previous_payable:2770,
        previous_paid       :4300,
        previous_dining_cost:1872,
        // running month
        stay_cost       :2200,
        garage_cost     :0,
    ...
    "01925315230":{
        name:"Masum",
        pre_previous_payable:5503,
        previous_paid       :7250,
        previous_dining_cost:1632,
        // running month
        stay_cost       :4500,
        garage_cost     :0,
    ...
    "01922362569":{
        name:"Razu",
        pre_previous_payable:2570,
        previous_paid       :3679,
        previous_dining_cost:1392,
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${316+972+56} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01738393696":{
        name:"Amrul Qais",
        pre_previous_payable:3785,
        previous_paid       :5000,
    ...
    "01794942131":{
        ...
        pre_previous_payable:5824,
        previous_paid       :6000,
        previous_dining_cost:1536,
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${0+1261+112+112+56} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01400709854":{
        name:"Rikta Islam",
        pre_previous_payable:3070,
        previous_paid       :6413,
        previous_dining_cost:2544,
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${174+112} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01532023080":{
        name:"Sony Hasan",
        pre_previous_payable:3570,
        previous_paid       :6237,
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${414} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01922635500":{
        name:"Rubel Hossain",
        pre_previous_payable:629,
        previous_paid       :3000,
        previous_dining_cost:2688,
        // running month
        stay_cost       :0,
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${1474+112} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01710430501":{
        name:"Samiul Islam",
...
var deadline = new Date(Date.parse(new Date("June 4,2023")));
