const members = {
    ...
    "01922362569":{
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${316+896+56+56+56+56} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01738393696":{
        name:"Amrul Qais",
    ...
    "01400709854":{
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${14+112+0+112} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01532023080":{
        name:"Sony Hasan",
    ...
    "01922635500":{
        ...
        totalCost,
        //memberMessage
        message:`<h2>Running due &nbsp;<strong style='color:red; font-weight: 600;'>${1026+112} &nbsp;</strong>TK.</h2>
        <p>If this due doesn't clear before Eid-ul-Adha you couldn't run your dining before 10<sup>th</sup> July</p>`
    },
    "01710430501":{
        name:"Samiul Islam",
